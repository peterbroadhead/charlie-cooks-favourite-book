...
const IndexPage = () => (
  ...
  <Layout>
    <div>
      ...
      <Link target="_blank" rel="noopener" to="/young-author-competition" className="inline-block  mt-5 -lg bg-orange shadow-md hover:bg-slate text-slate p-3 pl-5 pr-5  rounded-xl">Young Author Competition</Link>      
